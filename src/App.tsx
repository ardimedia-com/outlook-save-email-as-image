  ...
  const settingsBody = (
    <>
      ...
      {(info || noteParts.length > 0) && (
        // Status block: stats on top, advisory notes below, each with its own highlighted
        // background. Sticky to the bottom of the settings panel so it stays visible when the
        // controls scroll (solid bg so scrolling content doesn't bleed through).
        <div className="sticky bottom-0 z-10 bg-white dark:bg-slate-950">
          {info && (
